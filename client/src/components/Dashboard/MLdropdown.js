...
const MLdropdown = ({ onModelSelect,onLearningSelect, trainData, testData }) => {
  ...
  const handleLearningSelect = async (selectedValue) => {
    ...
    if (selectedValue === 'weeklySupervised') {
      try {
        const response = await axios.post('http://54.173.243.238:5000/weekly-supervised');
      ...
      try {
        const response = await axios.post('http://54.173.243.238:5000/active-learning');
        console.log(response.data);
        if (response.data.success) {
          setLearning(response.data.testCheck);
  ...
  const handleOptionSelect = async (selectedValue) => {
    ...
    if (selectedValue === 'logistic_regression') {
      try {
        const response = await axios.post('http://54.173.243.238:5000/logistic-regression');
        console.log(response.data);
        if (response.data.success) {
      ...
      try {
        const response = await axios.post('http://54.173.243.238:5000/naive-bayes');
        console.log(response.data);
        if (response.data.success) {
          setReport(response.data.report);
          setAccuracy(response.data.accuracy);
      ...
      try {
        const response = await axios.post('http://54.173.243.238:5000/random-forest');
        console.log(response.data);
        if (response.data.success) {
          setReport(response.data.report);
          setAccuracy(response.data.accuracy);
      ...
      try {
        const response = await axios.post('http://54.173.243.238:5000/support-vector-machine');
        console.log(response.data);
        if (response.data.success) {
          setReport(response.data.report);
          setAccuracy(response.data.accuracy);
      ...
      try {
        const response = await axios.post('http://54.173.243.238:5000/decision-tree');
        console.log(response.data);
        if (response.data.success) {
          setReport(response.data.report);
          setAccuracy(response.data.accuracy);
