    ...
    const MLdropdown = ({ onModelSelect,onLearningSelect, trainData, testData }) => {
      ...
      return (
        <div className="ml-dropdown-container">
          ...
          <br/><div className='text' style={{fontSize:'38px'}}>ML Models</div><br/>
          ...
          {/* supervised models */}
          <br/>
          <div className='text'>Supervised Models</div><br/><br/>
          ...
          {/* <br/><br/><br/><br/><br/>
          <div className='text'>Semi - Supervised Models</div><br/> */}
